      ...
      <div className="header_wrap">
        ...
        <div className="navbar_wrap">
          <nav className="Navbar">
            <div className="Logo_warap">
              {" "}
              <img src={Logo} alt="Loakram" />{" "}
            </div>

            <div className="textBtnContainer">
              <Link to="/" className="deskMenuListItem">
                Home
              </Link>
              <Link to="/specialities" className="deskMenuListItem">
                Specialties
              </Link>
              <Link to="/about" className="deskMenuListItem">
                About
              </Link>

              <Link to="/contact" className="deskMenuListItem">
                Contact
              </Link>
              <Link to="/gallery" className="deskMenuListItem">
                gallery
              </Link>
              <Link to="/doctors" className="deskMenuListItem">
                Doctors
              </Link>
            </div>
