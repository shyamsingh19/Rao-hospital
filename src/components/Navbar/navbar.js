    ...
    <>
      ...
      <nav id="Navbar">
        ...
        <div className="textBtnContainer">
          ...
          <Link activeClass="active" to='doctors' spy={true} smooth={true} offset={-100} duration={500} className="deskMenuListItem">Doctors</Link>
        ...
        <div className="mobmenu">
          ...
          <div className="navMenu" style={{ display: showMenu ? 'flex' : 'none' }}>
            ...
            <Link activeClass="active" to='doctors' spy={true} smooth={true} offset={-100} duration={500} className="listItem" onClick={() => setShowMenu(false)}>Doctors</Link>
